...
for runs in range(1,7):# this is working as number of balls in hand cricket game
    if runs in RUN:
...
# thinking how a user can only input runs from 1 to 6 and if user inputs more than 6 then 
# it should show invalid input and ask for input again
